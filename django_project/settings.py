...
MIDDLEWARE = [
    'debug_toolbar.middleware.DebugToolbarMiddleware', # django debug toolbar, take out after deployment
...
if 'test' in sys.argv:
    #Configuration for test database / python manage.py test
    DATABASES = {
        'default': {
    ...
    #Default configuration for postgres on Heroku
    DATABASES = {
